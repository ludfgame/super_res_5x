...
class HATModel(SRModel):
    ...
    def __init__(self, opt):
        ...
        #  if you need 5x woth 4x network, you can set 1.25x here
        self.post_resize_ratio = opt['post_resize_ratio']
    ...
    def post_process(self):
        ...
        # resize img here
        if self.post_resize_ratio != 1:
            self.output = cv2.resize(
                self.output, None, fx=self.post_resize_ratio, fy=self.post_resize_ratio, interpolation=cv2.INTER_CUBIC
            )
